...
class Tiket extends CI_Controller {
	...
	public function cekorder($id=''){
		...
		$sqlcek = $this->db->query("SELECT a.* FROM tbl_order AS a LEFT JOIN tbl_jadwal AS c ON a.kd_jadwal = c.kd_jadwal LEFT JOIN tbl_bank AS d ON a.kd_bank = d.kd_bank WHERE a.kd_order ='".$id."'")->result_array(); 
		if ($sqlcek == '') {
			$data['tiket'] = $sqlcek;
		// die(print_r($data));
